	...
	<head>
		...
		<script type="text/javascript">
			function editar(id, txt_tarefa){
				...
				//selecionar a div da tarefa cliclada
				...
				tarefa.insertBefore(form, tarefa[0])  //(qual arvore selecionada, qual o nó)
